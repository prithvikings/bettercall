...
export const LLMModelSelectorCard = ({ variants }: { variants: Variants }) => {
  return (
    ...
    >
      ...
      <div className="relative w-full h-[270px] mt-8 flex justify-center">
        <div className="absolute top-17 w-[85%] bg-white rounded-t-xl shadow-md border border-zinc-200/80 p-5 z-0">
        ...
        <motion.div
          ...
          className="absolute right-6 top-0 bg-white rounded-lg shadow-sm border border-zinc-200 p-3 w-48 z-20"
        >
