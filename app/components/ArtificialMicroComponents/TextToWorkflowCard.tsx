...
export const TextToWorkflowCard = ({ variants }: { variants: Variants }) => {
  return (
    ...
    >
      ...
      <div className="relative w-full h-[260px] mt-8 flex flex-col justify-end px-20 pb-6">
        {/* Bot Message Fade */}
        ...
        <div className="flex items-end justify-end gap-3 mb-4">
          ...
          <div className="w-6 h-6 rounded-full bg-white border border-zinc-200 shrink-0 overflow-hidden flex items-center justify-center">
            <img
