          ...
          <div className="flex flex-col gap-6">
            {leftCards.map((item) => (
              <motion.div
                ...
                className="flex flex-col text-left p-7 rounded-2xl bg-white/60 border border-zinc-100/50 hover:bg-white hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-zinc-200/60 transition-all duration-300"
              >
                <div className="text-blue-500 mb-4">{item.icon}</div>
                <h3 className="text-[15px] font-medium text-zinc-900 mb-2 font-poppins">
                  {item.title}
                </h3>
